...
namespace RegularHexMath
{
    public class HexagonalException : Exception
    {
        private class MessageBuilder
        {
            ...
            public MessageBuilder Append(HexGrid grid)
            {
        ...
        public HexagonalException(string message, HexGrid grid)
            : base(CreateBuilder(message).Append(grid).ToString())
        {
        }

        public HexagonalException(string message, HexGrid grid, params (string, object)[] fields)
